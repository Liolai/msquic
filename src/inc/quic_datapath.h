...
MaxUdpPayloadSizeForFamily(
    ...
    _In_ uint16_t Mtu) {
    return Family == QUIC_ADDRESS_FAMILY_INET ? Mtu - CXPLAT_MIN_IPV4_HEADER_SIZE - CXPLAT_UDP_HEADER_SIZE : Mtu - CXPLAT_MIN_IPV6_HEADER_SIZE - CXPLAT_UDP_HEADER_SIZE;
}
...
PacketSizeFromUdpPayloadSize(
    ...
    uint32_t PayloadSize = Family == QUIC_ADDRESS_FAMILY_INET ? UdpPayloadSize + CXPLAT_MIN_IPV4_HEADER_SIZE + CXPLAT_UDP_HEADER_SIZE : UdpPayloadSize + CXPLAT_MIN_IPV6_HEADER_SIZE + CXPLAT_UDP_HEADER_SIZE;
...
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_ACCEPT_CALLBACK)
        QUIC_STATUS(CXPLAT_DATAPATH_ACCEPT_CALLBACK)(
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_CONNECT_CALLBACK) void(CXPLAT_DATAPATH_CONNECT_CALLBACK)(
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_SEND_COMPLETE_CALLBACK) void(CXPLAT_DATAPATH_SEND_COMPLETE_CALLBACK)(
        _In_ CXPLAT_SOCKET* Socket,
        _In_ void* Context,
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_RECEIVE_CALLBACK) void(CXPLAT_DATAPATH_RECEIVE_CALLBACK)(
        _In_ CXPLAT_SOCKET* Socket,
        _In_ void* Context,
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_UNREACHABLE_CALLBACK) void(CXPLAT_DATAPATH_UNREACHABLE_CALLBACK)(
        _In_ CXPLAT_SOCKET* Socket,
        _In_ void* Context,
...
#ifdef QUIC_DISABLE_RECEIVE_COALESCING
#pragma message("QUIC_DISABLE_RECEIVE_COALESCING is defined. Receive coalescing is disabled.")
#endif
#ifdef QUIC_DISABLE_SEND_SEGMENTATION
#pragma message("QUIC_DISABLE_SEND_SEGMENTATION is defined. Send segmentation is disabled.")
#endif
...
#ifndef QUIC_DISABLE_RECEIVE_COALESCING
    CXPLAT_DATAPATH_FEATURE_RECV_COALESCING = 0x00000002,
#else
    CXPLAT_DATAPATH_FEATURE_RECV_COALESCING = 0x00000000,
#endif  // !QUIC_DISABLE_RECEIVE_COALESCING
#ifndef QUIC_DISABLE_SEND_SEGMENTATION
    CXPLAT_DATAPATH_FEATURE_SEND_SEGMENTATION = 0x00000004,
#else
    CXPLAT_DATAPATH_FEATURE_SEND_SEGMENTATION = 0x00000000,
#endif  // !QUIC_DISABLE_SEND_SEGMENTATION
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_DATAPATH_SEND_COMPLETE) void(CXPLAT_DATAPATH_SEND_COMPLETE)(
        _In_ CXPLAT_SOCKET* Socket,
...
//
_IRQL_requires_max_(PASSIVE_LEVEL) void CxPlatDataPathUninitialize(
...
//
_IRQL_requires_max_(PASSIVE_LEVEL) void CxPlatDataPathUpdatePollingIdleTimeout(
    _In_ CXPLAT_DATAPATH* Datapath,
...
// on an upcall!
//
_IRQL_requires_max_(PASSIVE_LEVEL) void CxPlatSocketDelete(
    _In_ CXPLAT_SOCKET* Socket);
...
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatSocketGetLocalAddress(
    _In_ CXPLAT_SOCKET* Socket,
...
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatSocketGetRemoteAddress(
    _In_ CXPLAT_SOCKET* Socket,
    _Out_ QUIC_ADDR* Address);
...
// callback.
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatRecvDataReturn(
...
_IRQL_requires_max_(DISPATCH_LEVEL)
    _Success_(return != NULL)
        CXPLAT_SEND_DATA* CxPlatSendDataAlloc(
            _In_ CXPLAT_SOCKET* Socket,
...
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatSendDataFree(
    _In_ CXPLAT_SEND_DATA* SendData);
...
_IRQL_requires_max_(DISPATCH_LEVEL)
    _Success_(return != NULL)
        QUIC_BUFFER* CxPlatSendDataAllocBuffer(
            _In_ CXPLAT_SEND_DATA* SendData,
...
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatSendDataFreeBuffer(
    _In_ CXPLAT_SEND_DATA* SendData,
...
//
_IRQL_requires_max_(DISPATCH_LEVEL) void CxPlatSocketSend(
    _In_ CXPLAT_SOCKET* Socket,
...
//
typedef _IRQL_requires_max_(DISPATCH_LEVEL)
    _Function_class_(CXPLAT_ROUTE_RESOLUTION_CALLBACK) void(CXPLAT_ROUTE_RESOLUTION_CALLBACK)(
...
//
void CxPlatResolveRouteComplete(
    _In_ void* Context,
...
_IRQL_requires_max_(PASSIVE_LEVEL) void CxPlatUpdateRoute(
...
_IRQL_requires_max_(PASSIVE_LEVEL) void CxPlatDataPathRssConfigFree(
